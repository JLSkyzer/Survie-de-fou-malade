...
execute as @a[scores={skyblock_ID=1..}] run scoreboard players add @a ID_1 1
execute as @a[scores={ID_1=1}] run scoreboard objectives remove skyblock_ID
execute as @a[scores={ID_1=20000..}] run scoreboard players set @a ID_1 100
...
execute as @a[scores={skyblock_ID=16}] run tellraw @a ["",{"text":"from the 2.1.4: ","bold":true},{"text":"\n\n"},{"text":"Fixed ","bold":true,"italic":true},{"text":"fix: #160","color":"red","clickEvent":{"action":"open_url","value":"https://github.com/Loweredgames/Skyblock-Classic-Edition/releases/edit/fix_1.18_1.19"}}]
